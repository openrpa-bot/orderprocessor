package com.nigam.openalgocommunicator.facade.impl.order_api;
...
// Communicator Class
@Service
public class OpenAlgoCommunicator_BasketOrder implements OpenAlgoCommunicator {
     public static final String API_PositionBook = "api/v1/basketorder";
