package com.nigam.brokercrawler.quartz.scheduler;

import com.nigam.brokercrawler.quartz.callback.AfterMarketBrokerCrawler;
import com.nigam.brokercrawler.quartz.callback.DuringMarketBrokerCrawler;
...
@Slf4j
@Service
public class MarketCrawlerBrokerServices implements JobListener {
    ...
    private void init() throws SchedulerException {
        ...
        // ========== DURING MARKET JOB ==========
        JobDetail duringMarketJob = JobBuilder.newJob(DuringMarketBrokerCrawler.class)
        ...
        // ========== AFTER MARKET JOB ==========
        JobDetail afterMarketJob = JobBuilder.newJob(AfterMarketBrokerCrawler.class)
