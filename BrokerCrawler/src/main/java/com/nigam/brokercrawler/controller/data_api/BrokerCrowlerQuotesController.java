...
import com.nigam.openalgo.api.account_api.AnalyzerStatus;
import com.nigam.openalgo.api.data_api.Quotes;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/Quotes")
public class BrokerCrowlerQuotesController {
    @Autowired
    Quotes openalgoQueryExecutor;
    ...
    public String receiveJson(@RequestBody String jsonPayload) {
        ...
        try {
            jsonString = mapper.writeValueAsString(openalgoQueryExecutor.sendQuery(serverIP, serverPort, apiKey, "RELIANCE", "NSE"));
        } catch (Exception e) {
