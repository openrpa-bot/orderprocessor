...
import com.nigam.openalgo.api.orders_api.OpenPosition;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/OpenPosition")
public class BrokerCrowlerOpenPositionController {
    @Autowired
    OpenPosition openalgoQueryExecutor;
