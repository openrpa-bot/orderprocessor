...
import com.nigam.openalgo.api.orders_api.PlaceSmartOrder;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/PlaceSmartOrder")
public class BrokerCrowlerPlaceSmartOrderController {
    @Autowired
    PlaceSmartOrder openalgoQueryExecutor;
