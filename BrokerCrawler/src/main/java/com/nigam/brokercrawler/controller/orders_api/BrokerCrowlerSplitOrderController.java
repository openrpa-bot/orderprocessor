...
import com.nigam.openalgo.api.orders_api.SplitOrder;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/SplitOrder")
public class BrokerCrowlerSplitOrderController {
    @Autowired
    SplitOrder openalgoQueryExecutor;
