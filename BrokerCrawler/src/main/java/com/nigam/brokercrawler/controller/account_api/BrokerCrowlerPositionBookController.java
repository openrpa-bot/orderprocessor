...
import com.nigam.openalgo.api.account_api.PositionBook;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/PositionBook")
public class BrokerCrowlerPositionBookController {
    @Autowired
    PositionBook openalgoQueryExecutor;
