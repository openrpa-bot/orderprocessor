...
import com.nigam.openalgo.api.account_api.Funds;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/funds")
public class BrokerCrowlerFundsController {
    @Autowired
    Funds openalgoQueryExecutor;
