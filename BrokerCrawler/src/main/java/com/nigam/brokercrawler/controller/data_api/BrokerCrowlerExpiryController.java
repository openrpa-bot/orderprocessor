...
import com.nigam.openalgo.api.data_api.Expiry;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/Expiry")
public class BrokerCrowlerExpiryController {
    @Autowired
    Expiry openalgoQueryExecutor;
    ...
    public String receiveJson(@RequestBody String jsonPayload) {
        ...
        try {
            jsonString = mapper.writeValueAsString(openalgoQueryExecutor.sendQuery(serverIP, serverPort, apiKey, "NIFTY", "NSE",  "futures"));
        } catch (Exception e) {
