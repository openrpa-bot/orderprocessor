...
import com.nigam.openalgo.api.data_api.Intervals;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/Intervals")
public class BrokerCrowlerIntervalsController {
    @Autowired
    Intervals openalgoQueryExecutor;
