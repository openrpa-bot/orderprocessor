...
import com.nigam.openalgo.api.orders_api.CancelAllOrder;
import com.nigam.openalgo.api.orders_api.ClosePosition;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/ClosePosition")
public class BrokerCrowlerClosePositionController {
    @Autowired
    ClosePosition openalgoQueryExecutor;
