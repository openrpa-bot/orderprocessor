...
import com.nigam.openalgo.api.data_api.OptionGreeks;
import com.nigam.openalgo.api.data_api.OptionSymbol;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/OptionGreeks")
public class BrokerCrowlerOptionGreeksController {
    @Autowired
    OptionGreeks openalgoQueryExecutor;
