...
import com.nigam.openalgo.api.account_api.TradeBook;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/TradeBook")
public class BrokerCrowlerTradeBookController {
    @Autowired
    TradeBook openalgoQueryExecutor;
