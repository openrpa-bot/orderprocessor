...
import com.nigam.openalgo.api.orders_api.OrderStatus;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/OrderStatus")
public class BrokerCrowlerOrderStatusController {
    @Autowired
    OrderStatus openalgoQueryExecutor;
