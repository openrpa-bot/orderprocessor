...
import com.nigam.openalgo.api.data_api.Depth;
import com.nigam.openalgo.api.data_api.History;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/History")
public class BrokerCrowlerHistoryController {
    @Autowired
    History openalgoQueryExecutor;
    ...
    public String receiveJson(@RequestBody String jsonPayload) {
        ...
        try {
            jsonString = mapper.writeValueAsString(openalgoQueryExecutor.sendQuery(serverIP, serverPort, apiKey, "RELIANCE", "NSE", "1min", "2023-01-01", "2023-01-31"));
        } catch (Exception e) {
