...
import com.nigam.openalgo.api.data_api.Search;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/Search")
public class BrokerCrowlerSearchController {
    @Autowired
    Search openalgoQueryExecutor;
    ...
    public String receiveJson(@RequestBody String jsonPayload) {
        ...
        try {
            jsonString = mapper.writeValueAsString(openalgoQueryExecutor.sendQuery(serverIP, serverPort, apiKey, "NIFTY 25000 JUL CE", "NSE"));
        } catch (Exception e) {
