...
import com.nigam.openalgo.api.account_api.OrderBook;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/OrderBook")
public class BrokerCrowlerOrderBookController {
    @Autowired
    OrderBook openalgoQueryExecutor;
