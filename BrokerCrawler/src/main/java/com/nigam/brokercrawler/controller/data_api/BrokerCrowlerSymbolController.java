...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/Symbol")
public class BrokerCrowlerSymbolController {
    @Autowired
    Symbol openalgoQueryExecutor;
    ...
    public String receiveJson(@RequestBody String jsonPayload) {
        ...
        try {
            jsonString = mapper.writeValueAsString(openalgoQueryExecutor.sendQuery(serverIP, serverPort, apiKey, "ACC", "NSE"));
        } catch (Exception e) {
