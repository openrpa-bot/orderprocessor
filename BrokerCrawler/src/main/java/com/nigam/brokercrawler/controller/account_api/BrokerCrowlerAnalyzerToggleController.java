...
import com.nigam.openalgo.api.account_api.AnalyzerToggle;
...
@Slf4j
@RestController
@RequestMapping("/broker-crawler/v1/analyzer/toggle")
public class BrokerCrowlerAnalyzerToggleController {
    @Autowired
    AnalyzerToggle openalgoQueryExecutor;
    ...
    public String receiveJson(@RequestBody String jsonPayload) {
        ...
        try {
            jsonString = mapper.writeValueAsString(openalgoQueryExecutor.sendQuery(serverIP, serverPort, apiKey, mode));
        } catch (Exception e) {
