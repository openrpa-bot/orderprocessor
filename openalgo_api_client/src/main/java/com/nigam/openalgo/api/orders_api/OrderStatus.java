...
public class OrderStatus {
    ...
    public JsonNode sendQuery(String serverIP,
        ...
        log.trace("OrderStatus sent to server " + serverIP + " on port " + serverPort + " with API key " + apiKey);
