...
public class ClosePosition {
    ...
    public JsonNode sendQuery(String serverIP,
        ...
        log.trace("ClosePosition sent to server " + serverIP + " on port " + serverPort + " with API key " + apiKey);
