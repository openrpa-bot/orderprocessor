...
public class OptionGreeks {
    ...
    public JsonNode sendQuery(String serverIP,
        ...
        log.trace("OptionGreeks sent to server " + serverIP + " on port " + serverPort + " with API key " + apiKey);
