...
public class Quotes {
    ...
    public JsonNode sendQuery(String serverIP,
        ...
        log.trace("Quotes sent to server " + serverIP + " on port " + serverPort + " with API key " + apiKey);
