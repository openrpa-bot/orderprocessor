...
public class CancelOrder {
    ...
    public JsonNode sendQuery(String serverIP,
        ...
        log.trace("CancelOrder sent to server " + serverIP + " on port " + serverPort + " with API key " + apiKey);
