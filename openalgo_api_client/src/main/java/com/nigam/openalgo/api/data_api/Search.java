...
public class Search {
    ...
    public JsonNode sendQuery(String serverIP,
        ...
        log.trace("Search sent to server " + serverIP + " on port " + serverPort + " with API key " + apiKey);
