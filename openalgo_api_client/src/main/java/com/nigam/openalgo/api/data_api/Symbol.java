...
public class Symbol {
    ...
    public JsonNode sendQuery(String serverIP,
        ...
        log.trace("Symbol sent to server " + serverIP + " on port " + serverPort + " with API key " + apiKey);
